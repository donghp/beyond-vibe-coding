...
export function renderPillarCard({ title, headline, desc, img, linkUrl = null }) {
  const targetUrl = linkUrl || PUBLIC_ROUTES.platform;
  return `
    <div style="background:#ffffff;border:1px solid #E2E8F0;border-radius:16px;padding:32px;display:flex;flex-direction:column;box-shadow:0 4px 12px rgba(11,23,39,0.015);">
      ...
      <a href="${targetUrl}" style="font-weight:700;color:#0066FF;text-decoration:none;">${I18nManager.t('public.learn_more')} →</a>
    </div>
  `;
}
